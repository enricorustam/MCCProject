...
namespace Client.Pdf
{
    public class SupervisorPdf
    {
        ...
        public byte[] Prepare(List<Supervisor> supervisors)
        {
        ...
        private void ReportHeader()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("Supervisors Data", _fontSylye));
            ...
            _pdfPCell = new PdfPCell(new Phrase("Supervisors List", _fontSylye));
            _pdfPCell.Colspan = _totalColumn;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void ReportBody()
        {
            ...
            foreach (Supervisor supervisor in _supervisors)
            {
                ...
                _pdfPCell = new PdfPCell(new Phrase(supervisor.Id.ToString(), _fontSylye));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);
