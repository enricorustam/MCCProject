...
namespace Client.Pdf
{
    public class EmployeePdf
    {
        ...
        public byte[] Prepare(List<Employee> employees)
        {
        ...
        private void ReportBody()
        {
            ...
            foreach (Employee employee in _employees)
            {
                ...
                _pdfPCell = new PdfPCell(new Phrase(employee.Id.ToString(), _fontSylye));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);
                ...
                _pdfPCell = new PdfPCell(new Phrase(employee.NIP.ToString(), _fontSylye));
                _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _pdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_pdfPCell);
